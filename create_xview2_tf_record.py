...
parser.add_argument('--data_dir', type=str, default='./dataset/xView2',
...
parser.add_argument('--train_data_list', type=str, default='./dataset/xView2/train.txt',
                    help='Path to the file listing the training data.')

parser.add_argument('--valid_data_list', type=str, default='./dataset/xView2/val.txt',
                    help='Path to the file listing the validation data.')

parser.add_argument('--image_data_dir', type=str, default='PNGImages',
